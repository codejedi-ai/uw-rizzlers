...
-  const drawEvent = (ctx: CanvasRenderingContext2D, event: Event) => {
-    const width = 200;
-    const height = 150;
...
-    // Draw event card
-    ctx.fillStyle = event.category === 'Tech' ? '#3B82F6' : 
-                   event.category === 'Social' ? '#10B981' :
-                   event.category === 'Workshop' ? '#F59E0B' : '#8B5CF6';
-    ctx.fillRect(event.x, event.y, width, height);
-
-    // Draw border
-    ctx.strokeStyle = '#fff';
-    ctx.lineWidth = 2;
-    ctx.strokeRect(event.x, event.y, width, height);
-
-    // Draw text
-    ctx.fillStyle = '#fff';
-    ctx.font = 'bold 16px Arial';
-    ctx.fillText(event.title, event.x + 10, event.y + 30);
-    
-    ctx.font = '12px Arial';
-    ctx.fillText(event.description.substring(0, 30) + '...', event.x + 10, event.y + 50);
-    ctx.fillText(`📅 ${event.date}`, event.x + 10, event.y + 70);
-    ctx.fillText(`🕐 ${event.time}`, event.x + 10, event.y + 90);
-    ctx.fillText(`📍 ${event.location}`, event.x + 10, event.y + 110);
-    ctx.fillText(`👥 ${event.attendees}/${event.maxAttendees}`, event.x + 10, event.y + 130);
...
+                fontWeight: 'bold'
           ...
           <div style={{
-            backgroundColor: selectedEvent.category === 'Tech' ? '#3B82F6' : 
-                           selectedEvent.category === 'Social' ? '#10B981' :
-                           selectedEvent.category === 'Workshop' ? '#F59E0B' : '#8B5CF6',
...
-          <p style={{ marginBottom: '15px', lineHeight: '1.5', color: '#ccc' }}>
+          <p style={{ 
+            marginBottom: '15px', 
+            lineHeight: '1.6', 
+            color: '#654321',
...
-            <div style={{ fontSize: '14px', marginBottom: '5px', color: '#ccc' }}>
